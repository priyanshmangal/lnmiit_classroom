    ...
    <div class="container">
		...
		<div class="col-sm-6 col-sm-offset-6">
          <ul class="nav navbar-nav">
              ...
              <li>
                  <a href="streamst.php?sub=<?php echo $_SESSION["sub"] ?>" role="button" aria-haspopup="true" aria-expanded="false"><i
                    ...
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
							...
							<div class="panel-footer">
								...
								<a href="<?php echo substr($row['doc'], 3); ?>" download class="btn btn-primary btn-rounded btn-icon"><i class="fa fa-cloud-download"></i> Download</a>
								<?php }} ?>
							</div>
						</div>
						<!-- --------------------------------------------     -->
