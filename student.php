                 ...
                 <div class="col-sm-7 col-sm-offset-1" >
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<a href="st_course.php" class="btn btn-link btn-sm blink" ><h3>COURSE REGISTERATION</h3></a>
					...
					<div class="panel-body" >
                       <div class="scrol">
                            ...
                            <a href="streamst.php?sub=<?php echo $arr[$i] ?>" class="btn btn-info btn-block"><?php echo $arr[$i] ?></a><br>
							<?php } ?>
